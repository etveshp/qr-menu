          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div>
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2.5 bg-[#3E2F26] text-[#FAF6EE] text-[11px] uppercase tracking-widest font-semibold hover:bg-[#231913] transition-colors rounded-xl disabled:opacity-50 disabled:cursor-not-allowed"
                >
              ...
              {onSaveQr && (
                <button
                  ...
                  disabled={!qrCodeDataUrl || !!downloading}
                  onClick={onSaveQr}
                  className="hidden lg:inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-[#C09E6D] text-white text-[11px] uppercase tracking-widest font-semibold hover:bg-[#ad8b5b] transition-colors rounded-xl disabled:opacity-50 disabled:cursor-not-allowed"
                >
            ...
            {onSaveQr && (
              <button
                ...
                disabled={!qrCodeDataUrl || !!downloading}
                onClick={onSaveQr}
                className="mt-3 w-full lg:hidden inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-[#C09E6D] text-white text-[11px] uppercase tracking-widest font-semibold hover:bg-[#ad8b5b] transition-colors rounded-xl disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <Save className="w-4 h-4" />
                {t('saveQrButton')}
              </button>
